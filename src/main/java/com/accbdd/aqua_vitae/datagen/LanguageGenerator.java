...
public class LanguageGenerator extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addItem(ModItems.BREWMASTER_MONOCLE, "Brewmaster's Monocle");
        addItem(ModItems.BREATHALYZER, "Breathalyzer");

        addIngredient(BuiltInIngredients.APPLE, "Apple");
        addIngredient(BuiltInIngredients.HONEY, "Honey");
        addIngredient(BuiltInIngredients.NETHER_WART, "Nether Wart");
        addIngredient(BuiltInIngredients.SWEET_BERRY, "Sweet Berry");
        addIngredient(BuiltInIngredients.BROWN_MUSHROOM, "Brown Mushroom");
        addIngredient(BuiltInIngredients.RED_MUSHROOM, "Red Mushroom");
        addIngredient(BuiltInIngredients.CHORUS_FRUIT, "Chorus Fruit");
        addIngredient(BuiltInIngredients.CHORUS_FLOWER, "Chorus Flower");
        addIngredient(BuiltInIngredients.MELON, "Melon");
        addIngredient(BuiltInIngredients.PUMPKIN, "Pumpkin");
        addIngredient(BuiltInIngredients.CARROT, "Carrot");
        addIngredient(BuiltInIngredients.POTATO, "Potato");
        addIngredient(BuiltInIngredients.BEETROOT, "Beetroot");
        addIngredient(BuiltInIngredients.WHEAT, "Wheat");
        addIngredient(BuiltInIngredients.SUGAR, "Sugar");
        addIngredient(BuiltInIngredients.WHITE_DYE, "White Dye");
        addIngredient(BuiltInIngredients.LIGHT_GRAY_DYE, "Light Gray Dye");
        addIngredient(BuiltInIngredients.GRAY_DYE, "Gray Dye");
        addIngredient(BuiltInIngredients.BLACK_DYE, "Black Dye");
        addIngredient(BuiltInIngredients.BROWN_DYE, "Brown Dye");
        addIngredient(BuiltInIngredients.RED_DYE, "Red Dye");
        addIngredient(BuiltInIngredients.ORANGE_DYE, "Orange Dye");
        addIngredient(BuiltInIngredients.YELLOW_DYE, "Yellow Dye");
        addIngredient(BuiltInIngredients.LIME_DYE, "Lime Dye");
        addIngredient(BuiltInIngredients.GREEN_DYE, "Green Dye");
        addIngredient(BuiltInIngredients.CYAN_DYE, "Cyan Dye");
        addIngredient(BuiltInIngredients.LIGHT_BLUE_DYE, "Light Blue Dye");
        addIngredient(BuiltInIngredients.BLUE_DYE, "Blue Dye");
        addIngredient(BuiltInIngredients.PURPLE_DYE, "Purple Dye");
        addIngredient(BuiltInIngredients.MAGENTA_DYE, "Magenta Dye");
        addIngredient(BuiltInIngredients.PINK_DYE, "Pink Dye");

        addFlavor(BuiltInFlavors.BREADY, "Bready");
        addFlavor(BuiltInFlavors.FRUITY, "Fruity");
        addFlavor(BuiltInFlavors.LUMINOUS, "Luminous");
        addFlavor(BuiltInFlavors.FLORAL, "Floral");
        addFlavor(BuiltInFlavors.SULFURIC, "Sulfuric");
        addFlavor(BuiltInFlavors.EARTHY, "Earthy");
        addFlavor(BuiltInFlavors.FUNKY, "Funky");
        addFlavor(BuiltInFlavors.STARCHY, "Starchy");
        addFlavor(BuiltInFlavors.SOUR, "Sour");
        addFlavor(BuiltInFlavors.SWEET, "Sweet");
        addFlavor(BuiltInFlavors.CRISP, "Crisp");
        addFlavor(BuiltInFlavors.HEAVY, "Heavy");
        addFlavor(BuiltInFlavors.OZONE, "Ozone");
        addFlavor(BuiltInFlavors.WISPY, "Wispy");
