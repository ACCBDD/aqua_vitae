...
public class MashTunScreen extends AbstractContainerScreen<MashTunMenu> {
    ...
    protected void init() {
        super.init();
        addRenderableWidget(new FluidGaugeWidget(this.leftPos + 11, this.topPos + 17, 7, 52, menu::getInputFluid, MashTunBlockEntity.MAX_FLUID));
        addRenderableWidget(new FluidGaugeWidget(this.leftPos + 114, this.topPos + 17, 51, 52, menu::getOutputFluid, MashTunBlockEntity.MAX_FLUID));
    }
