...
public class Constants {
    ...
    public static final MutableComponent COMPONENT_FLAVORS = Component.translatable("properties.aqua_vitae.flavors", ModKeyMappings.FLAVORS_MAPPING.get().getTranslatedKeyMessage().copy().withStyle(ChatFormatting.GOLD));
