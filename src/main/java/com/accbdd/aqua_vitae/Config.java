...
public class Config {
    ...
    // a list of strings that are treated as resource locations for inputs
    private static final ModConfigSpec.ConfigValue<List<? extends String>> ITEM_STRINGS = BUILDER.comment("A list of inputs to log on common setup.").defineListAllowEmpty("inputs", List.of("minecraft:iron_ingot"), Config::validateItemName);
    ...
    static void onLoad(final ModConfigEvent event) {
        ...
        // convert the list of strings into a set of inputs
