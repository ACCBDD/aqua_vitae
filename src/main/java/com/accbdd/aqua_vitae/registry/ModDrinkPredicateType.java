...
public class ModDrinkPredicateType {
    ...
    public static final DeferredHolder<DrinkPredicateType, DrinkPredicateType> STRICT_INGREDIENT = DRINK_PREDICATE_TYPE.register("strict_ingredient", () -> StrictIngredientsPredicate.DRINK_PREDICATE_TYPE);
    public static final DeferredHolder<DrinkPredicateType, DrinkPredicateType> MINIMUM_MALT = DRINK_PREDICATE_TYPE.register("minimum_malt", () -> MinimumMaltPredicate.DRINK_PREDICATE_TYPE);
