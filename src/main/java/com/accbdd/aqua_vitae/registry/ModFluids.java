...
public class ModFluids {
    ...
    private static DeferredHolder<Fluid, FlowingFluid> registerSource(String name, BaseFlowingFluid.Properties properties) {
        DeferredHolder<Fluid, FlowingFluid> register = FLUIDS.register(name, () -> new BaseFlowingFluid.Source(properties));
        REGISTERED.add(register);
        return register;
    }

    private static DeferredHolder<Fluid, FlowingFluid> registerFlowing(String name, BaseFlowingFluid.Properties properties) {
        DeferredHolder<Fluid, FlowingFluid> register = FLUIDS.register(name, () -> new BaseFlowingFluid.Flowing(properties));
        REGISTERED.add(register);
        return register;
    }
}
